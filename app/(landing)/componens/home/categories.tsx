...
const CategoriesSection = () =>{
    return (
        ...
        <div className="flex justify-between">
            ...
            <Link href="#" className="flex gap-2 text-primary font-medium text-14px">
        ...
        <div className="grid grid-cols-6 gap-12 mt-8">
            {
                ...
                <div className="rounded-lg bg-gradient-to-r from-[#F1F1F1] to-[#F7F7F7] w-full aspect-square flex justify-center items-center" 
                key={index}
                >
